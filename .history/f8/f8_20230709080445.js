...
//logical if.else
let logical = 0 || 0 || 0 || null || false; //&& nhaanj 6 giá trị của falsy không có nhận giá trị cuối.
// `||` nếu trong các giá trị không có giá trị falsy thì sẽ nhận giá trị đầu không nhận falsy nếu tất cả là 
