...
//làm việc với chuỗi.
/**
 * indexOf--tìm kiếm giá trị nằm ở vị trí bao nhiều từ trái - phải
 * lastIndexOf -- tìm kiế giá trị nằm ở vị trí nào từ phải sang trái,
 */
let myString = 'Trinh xuan ha';
console.log(myString.indexOf('a'));
console.log(myString.indexOf('a', 9));
console.log(myString.lastIndexOf('a', 9));
