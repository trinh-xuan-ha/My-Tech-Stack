  ...
  return (
    <div id="main">
      ...
      <div className="main_btn">
        <button onClick={() => handleButtonClick(currentGroup)}>1</button>
        <button onClick={() => handleButtonClick(currentGroup)}>2</button>
        <button onClick={() => handleButtonClick(currentGroup)}>3</button>
      </div>
    </div>
  );
}
