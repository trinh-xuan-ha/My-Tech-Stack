  ...
  return (
    <nav className="look-shop">
      ...
      <div className="look-shop-cart">
        <CartLook
          logo={
            "https://miona-vinovatheme.myshopify.com/cdn/shop/files/img-1-5_768x.jpg?v=1687334631"
          }
        />
        <CartLook
          logo={
            "https://miona-vinovatheme.myshopify.com/cdn/shop/files/img-1-6_768x.jpg?v=1687334630"
          }
        />
      </div>
    </nav>
