  ...
  return (
    <div id="main">
      ...
      <div
        ...
        style={{
          // Điều chỉnh giá trị transform để hiển thị nhóm cart tương ứng
          transform: `translate3d(-${(currentGroup - 1) * 100}%, 0, 0)`,
        }}
      >
        {groups.map((group, groupIndex) => (
          <div className="main_product_group" key={groupIndex}>
            {group.map((maincart, index) => (
              <MainCart
                key={index}
