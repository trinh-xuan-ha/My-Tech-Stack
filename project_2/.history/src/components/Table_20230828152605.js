...
function Table() {
  ...
  let handleCreateForm = () => {
    let createBtn = document.querySelector("#submit_button");
    console.log(createBtn);
    createBtn.onclick = () => {
      let name = document.querySelector("#student_input");
      console.log(name);
    };
  };
  ...
  return (
    <div className="table_call">
      ...
      <From handleCreateForm={handleCreateForm} />
    </div>
  );
}
