...
const [isNavGroupChildrenVisible, setNavGroupChildrenVisible] = useState(false);

const handleNavListClick = () => {
  setNavGroupChildrenVisible(true);
};
  return (
    <aside className="sidebar">
      <div className="sidebar_list">
        ...
        <ul className="nav_list" onClick={setNavGroupChildrenVisible}>
